...
?>
     ...
     $query = "SELECT * FROM Usuarios inner join Personas on Personas.CodPersona = Usuarios.CodPersona inner join Paises on Personas.CodPais = Paises.CodPais WHERE Usuarios.CodUsuario ='$Usuario'";
